...
namespace TopDownShooter
{
  public class McMouseControl
  {
    ...
    public void Update()
    {
      ...
      if (
          newMouse.LeftButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed
    ...
    public virtual bool LeftClickHold()
    {
         ...
         )
      {
        ...
        if (
            Math.Abs(newMouse.Position.X - firstMouse.Position.X) > 8
    ...
    {
      if (
          newMouse.LeftButton == Microsoft.Xna.Framework.Input.ButtonState.Released
          && oldMouse.LeftButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed
         )
      {
        dragging = false;
    ...
    {
      if (
          newMouse.RightButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed
    ...
    {
      if (
          newMouse.RightButton == Microsoft.Xna.Framework.Input.ButtonState.Released
          && oldMouse.RightButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed
         )
      {
        dragging = false;
